        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5 justify-center">
            <motion.div
              ...
              viewport={{ once: true }}
              className="animate_left relative hidden"
            >
            ...
            >
              ...
              <h2 className="relative mb-6 text-4xl font-medium text-black dark:text-white">
                ...
                <span className="relative inline-block mt-1 before:absolute before:bottom-2.5 before:left-0 before:-z-1 before:h-3 before:w-full before:bg-titlebg dark:before:bg-titlebgdark">
                <AnimatedText />
                </span>
              </h2>
              <p>
                Visibilidade Orgânica e Conexões Estratégicas sob medida, <br></br>
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  ...
                  <p>Recebemos sua demanda com um olhar humano.</p>
                </div>
              </div>
              <div className="mt-7.5 flex items-center gap-5">
                <div className="flex h-15 w-15 items-center justify-center rounded-[50%] border border-stroke dark:border-strokedark dark:bg-blacksection">
                ...
                <div className="w-3/4">
                  ...
                  <p>Construimos a melhor estratégia para a sua marca.</p>
                </div>
              </div>
            </motion.div>
          </div>
